        ...
        <div class="card-header">
            <h3>
                <?php if ($user['id']): ?>
                    ...
                    <p style="margin-top:10px ;display :inline-block">Update user</p> <b><?php echo $user['name'] ?></b>
                <?php else: ?>
                    <a  class="btn btn-primary" href="index.php"><h4>Back Home</h4></a><br />
                    <p style="margin-top:10px ;">Create new User</p>
                <?php endif ?>
            </h3>
        </div>
        <div class="card-body">
